...
if __name__ == "__main__":
    ...
    my_league_id = 248334  # stoke players league

    league = eplfl.League(my_league_id)
    league_standing = eplfl.LeagueStanding(league)

    history = league_standing.points_history
    graph_points_history(league_standing, history, 'Gameweek Points History', 'stoke_gameweek_points_history.png')

    history = league_standing.points_total_by_gameweek
    graph_points_history(league_standing, history, 'Total Points History', 'stoke_total_points_history.png')

    history = league_standing.rank_history
    graph_rank_history(league_standing, history, 'League Rank History', 'stoke_league_rank_history.png')
